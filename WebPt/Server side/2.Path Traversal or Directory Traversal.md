...
- Absolute paths are often seen in error messages → can leak server structure (info disclosure). 
...
copy url of website and use katana to find parameters like filename, page etc. 

        katana -u [https://0a0000be048d54d880c25337003b0004.web-security-academy.net/](https://0a0000be048d54d880c25337003b0004.web-security-academy.net/)
...
             example: GET /image?filename=53.jpg HTTP/2
...
```
1. access the lab and capture the image request and send it to intruder.           ex=https://0a3400d204ac775f80883a7500010041.web-security-academy.net/image?filename=22.jpg
```
