...
1. Use Internal Storage: Always store sensitive data in the app's private directory 
2. 
3. (Context.getFilesDir()),
4. which creates files in /data/data/<package>/.
5. Avoid External Storage for Secrets: Never place PII, tokens, or passwords on External Storage.
