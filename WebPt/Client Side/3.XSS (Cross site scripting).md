...
Result: JavaScript executes! Alert pops up! ✗
```
...
│     (Payload in # never sent to server!)                     │
│                                                              │
│  2. JavaScript runs:                                         │
│                                                              │
│     SOURCE                                                   │
...
│     ┌─────────────────────────────────────┐                  │
│     │ alert(1) pops up!                                      │
│     │ Attacker could steal cookies, etc.                     │
│     └─────────────────────────────────────┘                  │
│                                                              │
└──────────────────────────────────────────────────────────────┘
```
...
3. DOM-Based JavaScript Injection
4. DOM-Based Link Manipulation
